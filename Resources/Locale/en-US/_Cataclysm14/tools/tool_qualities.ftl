...
# crowbar / axe
tool-quality-prying-name-T2 = [color=orange] Prying: 2 [/color]
# halligan bar / halligan axe
...
# hammer
tool-quality-hammering-name-T2 = [color=orange] Hammering: 2 [/color]
# sledgehammer
...
# hacksaw
tool-quality-metal-sawing-name-T2 = [color=orange] Metal sawing: 2 [/color]
# reciprocating saw
tool-quality-metal-sawing-name-T3 = [color=red] Metal sawing: 3 [/color]
# breacher / angle grinder / power circular saw
...
# scalpel
tool-quality-fine-cutting-name-T2 = [color=orange] Fine cutting: 2 [/color]
# high tech surgical tool
...
# bronze/metal chisel
tool-quality-chiseling-name-T2 = [color=orange] Chiseling: 2 [/color]
# metalworking chisel
