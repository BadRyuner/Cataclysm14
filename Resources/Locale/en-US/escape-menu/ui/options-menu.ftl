...
ui-options-hud-layout-default = Vanilla Default (Unrecommended)
ui-options-hud-layout-separated = Separated (CDDA Default)
...
ui-options-function-open-crafting-menu = Open construction menu
