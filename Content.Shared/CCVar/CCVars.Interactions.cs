...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<bool> StorageWindowTitle =
        CVarDef.Create("control.storage_window_title", true, CVar.CLIENTONLY | CVar.ARCHIVE); //Cataclysm14, false -> true
    ...
    public static readonly CVarDef<int> StorageLimit =
        CVarDef.Create("control.storage_limit", 10, CVar.REPLICATED | CVar.SERVER); //Cataclysm14, 2 -> 10
