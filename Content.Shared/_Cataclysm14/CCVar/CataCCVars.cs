...
public sealed class CataCCVars
{
    ...
    /// <summary>
    /// How many respawns per frame
    /// </summary>
    public static readonly CVarDef<int> ForageMaxRespawnPerOnce =
            CVarDef.Create("cata.forage_max_respawn_per_once", 25, CVar.SERVERONLY);
}
